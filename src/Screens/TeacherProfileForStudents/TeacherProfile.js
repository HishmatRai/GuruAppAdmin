...
import TeahersScrollCard from './../../Components/TeahersScrollCard/TeahersScrollCard'
...
const TeacherProfile = (props) => {
    ...
    return (
            ...
            <ImageBackground source={require('./../../img/login_background.png')} style={styles._image}>
                ...
                <ScrollView style={styles.scrollView}>
                    <View style={{ margin: 20 }}>
                        ...
                        <TeahersScrollCard path={props.navigation}/>
                        <Text style={{ color: "white", fontSize: 30 ,marginTop:10}}>Rate and Reviews</Text>
                        {/* <<<<<<<< Review Card  >>>>>>>>> */}
        ...
        <View style={styles._tab_bar_main}>
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("BookingTeachers")}
          >
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("NotificationsStudents")}
          >
            <Ionicons name="md-notifications" size={24} color="white" />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("TeacherProfileForStudents")}
          >
