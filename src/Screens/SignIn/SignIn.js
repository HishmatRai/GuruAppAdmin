        ...
        <ScrollView style={styles.scrollView}>
          <View style={{ margin: 20 }}>
            ...
            <View style={styles._forgot_remember_main}>
              ...
              {/* <<<<<<<< Forgot >>>>>>>>> */}
              <TouchableOpacity
                style={styles._forgot_password_button}
                onPress={() => props.navigation.navigate("ForgotPassowrd")}
              >
                <Text style={styles._forgot_password_button_text}>
                  Forgot Password?
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles._socail_login_main}>
              <Text style={styles._socail_login_heading}>Sign in with</Text>
            ...
            <View style={styles._register_main}>
              ...
              >
                <Text style={styles._register}> Sign up now</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
